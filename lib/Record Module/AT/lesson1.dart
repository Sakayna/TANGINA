...
class LessonRecordAT1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final globalVariables = Provider.of<GlobalVariables>(context, listen: false);
    final List<Map<String, dynamic>> quizData = [
      {'lesson': 1, 'quiz': 1, 'title': 'Lesson 1 Quiz 1', 'key': 'quiz1'},
      {'lesson': 1, 'quiz': 2, 'title': 'Lesson 1 Quiz 2', 'key': 'quiz2'},
    ];

    return Scaffold(
      appBar: AppBar(
        title: Text('Lesson 1 Quizzes'),
      ),
      body: Padding(
