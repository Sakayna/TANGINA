...
class LessonRecordAT5 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final globalVariables = Provider.of<GlobalVariables>(context, listen: false);
    final List<Map<String, dynamic>> quizData = [
      {'lesson': 5, 'quiz': 1, 'title': 'Lesson 5 Quiz 1', 'key': 'quiz7'},
      {'lesson': 5, 'quiz': 2, 'title': 'Lesson 5 Quiz 2', 'key': 'quiz8'},
    ];

    return Scaffold(
      appBar: AppBar(
        title: Text('Lesson 5 Quizzes'),
      ),
      body: Padding(
