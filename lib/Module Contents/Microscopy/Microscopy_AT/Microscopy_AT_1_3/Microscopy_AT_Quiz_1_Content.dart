...
class _Microscopy_AT_Quiz_1_ContentState
  ...
  int currentQuestionIndex = 0; // Tracks the current blank/question
  bool isAnswerEmpty = true; // Tracks if the current blank is empty
  ...
  /// Return item to original position if removed from target
